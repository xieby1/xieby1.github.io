...
* [declaration section](#declaration-section)
  * [Format definitions](#format-definitions)
    * [Syntax](#syntax)
    * [Source](#source)
  * [Template definition, ends with](#template-definition-ends-with)
    * [`Declare`: declaration (header output) templates](#declare-declaration-header-output-templates)
    * [`Decode`: decode-block templates](#decode-decode-block-templates)
    * [`Constructor`: decoder output templates](#constructor-decoder-output-templates)
    * [`Execute`: exec output templates](#execute-exec-output-templates)
